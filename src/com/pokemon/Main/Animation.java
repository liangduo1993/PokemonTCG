...
public class Animation {
	...
	public static void drawCardBack(Graphics g, int x, int y){
		g.drawImage(Game.cardback, x, y, Game.CARD_W*Game.CARD_SCALE, Game.CARD_H*Game.CARD_SCALE, null);
	}
	...
	public static void drawCardBack(Graphics g, int x, int y, double angle){
		...
		g.drawImage(img, x, y, img.getWidth()*Game.CARD_SCALE, img.getHeight()*Game.CARD_SCALE, null);
	}
